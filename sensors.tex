...
\AuthorCitation{Shanliang Yao, Xiaohui Zhu, Yong Yue, Yutao Yue, Tianlei Shi, Kaiyuan Yang, Yijie Chu.}
...
\textbf{conv3\_x}                  & 28$\times$28                  & $\begin{bmatrix}  
  3\times3, 128 \\  
  3\times3, 128 \\    
\end{bmatrix}\times2$
&
...
\end{bmatrix}\times4$               
                 \\ \hline
\textbf{conv4\_x}                  & 14$\times$14                  & $\begin{bmatrix}  
  3\times3, 256 \\  
  3\times3, 256 \\    
\end{bmatrix}\times2$
&
...
$\begin{bmatrix}  
  1\times1, 256 \\  
  3\times3, 256 \\
1\times1, 1024\end{bmatrix}\times6$ 
& 
$\begin{bmatrix}  
  1\times1, 256 \\  
  3\times3, 256 \\
...
\textbf{conv5\_x}                  & 7$\times$7                    & $\begin{bmatrix}  
  3\times3, 512 \\  
  3\times3, 512 \\    
\end{bmatrix}\times2$
&
...
\times 3$               
                \\ \hline
\textbf{}                          & 1$\times$1                   & \multicolumn{4}{c}{average pool, 1000-d fc, softmax}                                               \\ \hline
\multicolumn{2}{c|}{\textbf{FLOPs}}  & $1.8\times10^{9}$ & $3.6\times10^{9}$ & $3.8\times10^{9}$ & $7.6\times10^{9}$  \\ \hline
\end{tabular}
\label{tbl:ResNet}
\end{table*}
...
%\begin{figure}[htbp]
%\centering
%\includegraphics[width=0.98\columnwidth]{images/ResNet50.png}
%\caption{Structure of ResNet (Source: \cite{he2016deep}).}
%\label{fig:ResNet}
%\end{figure}
...
\includegraphics[width=0.45\columnwidth]{images/pr-curve.png}
}
\quad
\subfigure[PRC for PP-YOLO-mobile model (IoU = 0.5)]{
\includegraphics[width=0.45\columnwidth]{images/pr-curve-1.png}
}
